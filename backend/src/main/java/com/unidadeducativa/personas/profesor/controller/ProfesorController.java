...
public class ProfesorController {
    ...
    @ApiResponse(responseCode = "200", description = "Profesores listados correctamente",
            content = @Content(mediaType = "application/json",
                    array = @ArraySchema(schema = @Schema(implementation = ProfesorResponseDTO.class))))
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Profesor encontrado",
                    content = @Content(schema = @Schema(implementation = ProfesorResponseDTO.class))),
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Perfil del profesor obtenido correctamente",
                    content = @Content(schema = @Schema(implementation = ProfesorResponseDTO.class))),
            @ApiResponse(responseCode = "404", description = "Profesor no encontrado")
    })
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Profesor registrado exitosamente",
                    content = @Content(schema = @Schema(implementation = ProfesorResponseDTO.class))),
