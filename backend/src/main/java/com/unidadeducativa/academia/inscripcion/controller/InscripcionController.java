...
public class InscripcionController {
        ...
        // -------------------------------
        @Operation(summary = "Registrar inscripción", description = "Registra una nueva inscripción para un estudiante en la gestión académica activa.")
        @ApiResponses({
                        @ApiResponse(responseCode = "200", description = "Inscripción registrada correctamente", content = @Content(schema = @Schema(implementation = InscripcionResponseDTO.class))),
        ...
        // ------------------------------------------
        @Operation(summary = "Listar inscripciones de un estudiante", description = "Devuelve todas las inscripciones realizadas por el estudiante con el ID proporcionado.")
        ...
        // ------------------------------------------
        @Operation(summary = "Listar inscripciones por curso", description = "Devuelve todas las inscripciones al curso con el ID especificado.")
        @ApiResponse(responseCode = "200", description = "Inscripciones listadas correctamente", content = @Content(array = @ArraySchema(schema = @Schema(implementation = InscripcionResponseDTO.class))))
        ...
        // ------------------------------------------
        @Operation(summary = "Listar inscripciones por gestión académica", description = "Devuelve todas las inscripciones registradas para una gestión específica.")
        @ApiResponse(responseCode = "200", description = "Inscripciones listadas correctamente", content = @Content(array = @ArraySchema(schema = @Schema(implementation = InscripcionResponseDTO.class))))
        @PreAuthorize("hasAnyRole('ROLE_DIRECTOR', 'ROLE_SECRETARIA')")
        ...
        // ------------------------------------------
        @Operation(summary = "Listar estudiantes inscritos en un curso", description = "Devuelve todos los estudiantes inscritos en el curso con el ID especificado.")
        @ApiResponse(responseCode = "200", description = "Estudiantes listados correctamente", content = @Content(array = @ArraySchema(schema = @Schema(implementation = InscripcionResponseDTO.class))))
        ...
        // ------------------------------------------
        @Operation(summary = "Cambiar estado de inscripción", description = "Permite actualizar el estado (ACTIVO, RETIRADO, etc.) de una inscripción.")
